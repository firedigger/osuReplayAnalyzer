...
namespace OsuDbAPI
{
    ...
    */
    public class Beatmap
    {
        ...
        public ushort NumHitcircles { get; set; }
        public ushort NumSliders { get; set; }
        public ushort NumSpinners { get; set; }
        ...
        public int DrainTimeMilliseconds { get; set; }
        public int PreviewPoint { get; set; }
        public int ID { get; set; }
        public int SetID { get; set; }
        public int ThreadID { get; set; }
        public byte GradeOsu { get; set; }
        ...
        public int LastModTime { get; set; }
